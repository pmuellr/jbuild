...
(function() {
  var HelpTasks, PROGRAM, Tasks, alignLeft, coffee, fs, getNodeModulesScripts, getTaskRunner, help, invokeNodeModuleScript, main, path, pkg, sanitizeFunctionName, watch, _,
    __slice = [].slice,
  ...
  global.defineModuleFunctions = function(dir) {
